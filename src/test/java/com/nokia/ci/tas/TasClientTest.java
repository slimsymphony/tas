...
public class TasClientTest  extends Thread implements TestAutomationServiceListener {
    ...
    public static void main(String[] arguments) {
        ...
        // Start demo
        try {
        	TasClientTest example = new TasClientTest();
            example.start();
        }
        catch (Exception e) {
